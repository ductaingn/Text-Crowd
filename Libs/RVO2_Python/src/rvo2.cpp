  ...
  __Pyx_RefNannySetupContext("setCarProperties (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_vDrivingMax)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("setCarProperties", 1, 13, 13, 2); __PYX_ERR(0, 276, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_vSteeringMax)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("setCarProperties", 1, 13, 13, 3); __PYX_ERR(0, 276, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_aDrivingMax)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("setCarProperties", 1, 13, 13, 4); __PYX_ERR(0, 276, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_phiMax)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("setCarProperties", 1, 13, 13, 5); __PYX_ERR(0, 276, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dtc)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("setCarProperties", 1, 13, 13, 6); __PYX_ERR(0, 276, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_errorPreferred)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("setCarProperties", 1, 13, 13, 7); __PYX_ERR(0, 276, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ka)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("setCarProperties", 1, 13, 13, 8); __PYX_ERR(0, 276, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_kv)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("setCarProperties", 1, 13, 13, 9); __PYX_ERR(0, 276, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_kp)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("setCarProperties", 1, 13, 13, 10); __PYX_ERR(0, 276, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_deltaV)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("setCarProperties", 1, 13, 13, 11); __PYX_ERR(0, 276, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 12:
        if (likely((values[12] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_deltaPhi)) != 0)) kw_args--;
        else {
...
static PyObject *__pyx_pw_4rvo2_14PyRVOSimulator_97setAgentCar(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("setAgentCar (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_agentCarNo)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_position)) != 0)) kw_args--;
...
static PyMethodDef __pyx_methods_4rvo2_PyRVOSimulator[] = {
  ...
  {"addAgentCar", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_5addAgentCar, METH_VARARGS|METH_KEYWORDS, 0},
  ...
  {"getAgentAgentNeighbor", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_21getAgentAgentNeighbor, METH_VARARGS|METH_KEYWORDS, 0},
  ...
  {"getAgentObstacleNeighbor", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_35getAgentObstacleNeighbor, METH_VARARGS|METH_KEYWORDS, 0},
  {"getAgentORCALine", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_37getAgentORCALine, METH_VARARGS|METH_KEYWORDS, 0},
  ...
  {"queryVisibility", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_67queryVisibility, METH_VARARGS|METH_KEYWORDS, 0},
  {"setAgentDefaults", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_69setAgentDefaults, METH_VARARGS|METH_KEYWORDS, 0},
  {"setAgentMaxNeighbors", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_71setAgentMaxNeighbors, METH_VARARGS|METH_KEYWORDS, 0},
  {"setAgentMaxSpeed", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_73setAgentMaxSpeed, METH_VARARGS|METH_KEYWORDS, 0},
  {"setAgentNeighborDist", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_75setAgentNeighborDist, METH_VARARGS|METH_KEYWORDS, 0},
  {"setAgentNeighborDist", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_77setAgentNeighborDist, METH_VARARGS|METH_KEYWORDS, 0},
  {"setAgentPosition", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_79setAgentPosition, METH_VARARGS|METH_KEYWORDS, 0},
  {"setAgentPrefVelocity", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_81setAgentPrefVelocity, METH_VARARGS|METH_KEYWORDS, 0},
  {"setAgentRadius", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_83setAgentRadius, METH_VARARGS|METH_KEYWORDS, 0},
  {"setAgentTimeHorizon", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_85setAgentTimeHorizon, METH_VARARGS|METH_KEYWORDS, 0},
  {"setAgentTimeHorizonObst", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_87setAgentTimeHorizonObst, METH_VARARGS|METH_KEYWORDS, 0},
  {"setAgentVelocity", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_89setAgentVelocity, METH_VARARGS|METH_KEYWORDS, 0},
  {"setCarProperties", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_91setCarProperties, METH_VARARGS|METH_KEYWORDS, 0},
  ...
  {"setAgentCar", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4rvo2_14PyRVOSimulator_97setAgentCar, METH_VARARGS|METH_KEYWORDS, 0},
 ...
 *     def clearObstacle(self):
 */
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_kp_s_Error_adding_obstacle_to_RVO_sim); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 163, __pyx_L1_error)
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_PyRVOSimulator, (PyObject *)&__pyx_type_4rvo2_PyRVOSimulator) < 0) __PYX_ERR(0, 92, __pyx_L1_error)
